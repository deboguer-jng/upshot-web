...
let projects = [
    {
        title: 'Genie',
        description: 'Buy and sell multiple NFTs across all major markets in a single transaction',
        url: 'https://genie.xyz',
        image: GeniePNG,
        ...
        title: 'PWN',
        description: 'Leverage NFTs in fixed duration loansHarness the power of nested NFTs',
