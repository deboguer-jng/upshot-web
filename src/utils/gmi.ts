...
export const gmiPercentRank = (percentile: number) => {
  ...
  if (percentile < 55) return [false, 45]
  if (percentile < 60) return [false, 40]
  if (percentile < 65) return [false, 35]
  if (percentile < 70) return [false, 30]
  if (percentile < 75) return [false, 25]
  if (percentile < 80) return [false, 20]
  if (percentile < 85) return [false, 15]
  if (percentile < 90) return [false, 10]
  if (percentile < 95) return [false, 5]
  if (percentile < 97.5) return [false, 2.5]
  if (percentile < 99) return [false, 1]
  if (percentile < 99.5) return [false, 0.5]
  return [false, 0.1]
}
